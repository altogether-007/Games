! function(e) {
    ...
    var n = i(5),
        ...
        a = i(1),
        r = i(2);
    document.getElementById("enduranceMode").addEventListener("click", () => n.a.enduranceMode()), document.getElementById("rushMode").addEventListener("click", () => n.a.rushMode()), document.getElementById("sprintMode").addEventListener("click", () => n.a.sprintMode()), document.getElementById("musicSwitch").addEventListener("change", (function() {
